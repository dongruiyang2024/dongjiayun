export const MISSION_DURATION = 150;
...
export const MISSION_PHASES = [
  ...
  { id: 'ascent', label: '升空爬升', start: 9, end: 60, description: '火箭垂直离开发射台，穿越稠密大气，按程序缓慢转向。' },
  { id: 'separation', label: '一级分离', start: 60, end: 70, description: '一级燃尽关机并分离，坠回地球；二级点火继续推进。' },
  { id: 'fairing', label: '整流罩分离', start: 70, end: 82, description: '离开稠密大气后，整流罩分离坠落，露出卫星。' },
  { id: 'insertion', label: '轨道注入', start: 82, end: 95, description: '二级继续加速，进入预定轨道后关机。' },
  { id: 'deployment', label: '卫星释放', start: 95, end: 105, description: '卫星与二级分离，展开太阳能板。' },
  { id: 'orbit', label: '绕地运行', start: 105, end: 150, description: '卫星依靠惯性与地球引力持续绕地运行。' },
];
