...
export const growthTimeline = [
  { date: '2026-02', icon: '🚲', title: '学会骑自行车', desc: '不再需要辅助轮啦！' },
  { date: '2026-02', icon: '💯', title: '数学考了100分', desc: '第一次数学满分！' },
  { date: '2026-01', icon: '🎨', title: '开始学水彩画', desc: '发现了画画的乐趣' },
  { date: '2026-01', icon: '📓', title: '开始写博客', desc: '记录成长的每一天' },
  { date: '2025-12', icon: '📚', title: '读完了第10本课外书', desc: '今年的阅读目标达成！' },
  { date: '2025-11', icon: '🏃', title: '运动会跑步第三名', desc: '明年要争取第一名！' },
  { date: '2025-09', icon: '🎒', title: '升入三年级', desc: '新学期，新开始！' },
